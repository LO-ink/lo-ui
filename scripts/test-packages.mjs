...
const html = renderToStaticMarkup(createElement(List, null, createElement(Cell, {title:'Saved app', trailing:createElement(Button,null,'Open')})));
...
const ui = <List><Cell title="Preferences" trailing={<Switch label="Updates" />} /><Cell title="App" onPress={() => {}} trailing={<Button>Open</Button>} /></List>;
void ui;
`,
  );
  ...
  console.log(
    "Clean UI tarballs: CSS/license, SSR rendering, and NodeNext/Bundler types pass.",
  );
} finally {
